...
export function ResumeLanguages({ data }: { data: IResumeLanguages }) {
  return (
    <View id="Languages">
...
export function ResumeContactMe({ data }: { data: IResumeContact }) {
  return (
    <View id="Contact Me" style={{ gap: 4 }}>
      <Texto size={14}>{data.label}</Texto>
      <View style={{ gap: 4 }}>
...
export function ResumeSkills({ data }: { data: IResumeSkill }) {
  return (
    <View id="Skills" style={{ gap: 4 }}>
      <Texto size={14}>{data.label}</Texto>
      <View style={{ gap: 4 }}>
        {data.items.map((e, i) => {
          // biome-ignore lint/suspicious/noArrayIndexKey: <explanation>
